...
import { Navbar, NavbarBrand,Nav, NavbarToggler, Collapse, NavItem, Form, Input, Jumbotron, Modal, Button, ModalBody, ModalHeader, FormGroup, Label } from 'reactstrap';
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal} >
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                <Label htmkFor="password">Password</Label>
